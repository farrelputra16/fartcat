    ...
    <section id="rewards" className="section">
      <div className="container">
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          ...
          <h2 className="section-title reveal" style={{ transitionDelay: '70ms', marginBottom: 8 }}>
          ...
          <p className="reveal section-body" style={{ transitionDelay: '210ms', margin: '0 auto 48px', textAlign: 'center' }}>
